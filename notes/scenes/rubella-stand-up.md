...
**Spine:** The designated podium is a laundry-room intercom. Madelyn put her on the list. The audience is folding chairs. Building bureaucracy is the comic engine.

**Emotional notes:** She is not discovering comedy. She is filing a complaint that happens to have a mic. Dry, not rapid-fire. Do not look at Lillith. Chairs creak; they do not clap.

**Locked sample lines (kept):**
...
**Neighbors:** elevator-counteroffer · lint-inventory · peggy-babcock-second · we-will-stand · Mara album *I Already Pay Rent* (player shelf, not this title card) · Lace Waterfall unused mic (cousin object, mouths off there)
...
```
INT. LAUNDRY ROOM — OPEN MIC — NIGHT

Honey-oak folding table as the stage. One unused brass-stem mic on a
short stand. Flickering fluorescent. Wet enamel on the floor grout
only. World's Okayest Tenant mug, half empty. Contraband detergent
bottle in reach. Rows of empty folding chairs. They creak. They do
not clap.

Madelyn is a clipboard silhouette in the last chair. No gavel.

Rubella sets the mug down like evidence.
```
...
```
Fluorescent tick. The chairs have crept one inch back.
FADE OUT.
```
...
## Picture order (Imagine)

Shoot **A** (podium lock) and **D** (land) first. Mouths on. Stack silent picture on the Voice bed.

1. Podium lock — unused mic, mug, empty first row, resignation face  
2. Detergent relic — bottle in the off-hand, no label text  
3. Heckle wide — Rubella does not turn; Lillith one chair back; clipboard last chair  
