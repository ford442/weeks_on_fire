...
export const staffRecords: StaffRecord[] = [
  {
    ...
    quote: "If the serpent rises on the snare hit, the line before it has to already be burning. Dialogue is just another instrument in the mix.",
    credits: ["Episode 01 — cold-open monologue", "Episode 02 — roadside confession structure", "Episode 02 — 480p Studio Huddle (meta pacing / HOA seed)", "Episode 03 — Laser Snakes narrative spine"],
    imageFile: "mara-vell.jpg",
  },
  {
    id: "julian-rook",
    name: "Julian Rook",
    ...
    quote: "We do not scale chaos. We schedule it. If the desert wants lasers, we give it lasers — on time, on budget, and with the prompt copied into the gallery.",
    credits: ["Series financing & delivery calendar", "External media hosting policy", "Production hub review cadence"],
    imageFile: "julian-rook.jpg",
  },
  {
    id: "soren-kade",
    name: "Soren Kade",
    ...
    quote: "The series is not about explaining the fire. It is about standing close enough that the heat rearranges the frame.",
    credits: ["Episode 03 — Laser Serpent Awakening", "Visual grammar for musical cutaways", "Shot language for Grok Imagine stills"],
    imageFile: "soren-kade.jpg",
  },
  {
    id: "nova-chen",
    name: "Nova Chen",
    ...
    credits: ["Halloween Snake Battle drop placement", "Catalog tagging for episode ties", "Style-prompt QA for Minimax batches"],
    imageFile: "nova-chen.jpg",
  },
  {
    id: "elio-marsh",
    name: "Elio Marsh",
