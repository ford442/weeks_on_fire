...
import cutawayImg0 from '../../../images/well-fall/wf-a-lip.jpg';
...
export const cutawaySuggestions: CutawaySuggestion[] = [
  ...
  },
  {
    ...
    runtime: "~2:47 (option_a bed)",
    episode: "Musical Cutaway / Glam catalog",
    songId: "big-city",
    songTitle: "Big City",
    summary: "Lillith starts, Rubella answers, Kenji spoken tag. Small Glamora club stage as A-roll; B-roll is inappropriately huge hair as architecture — skyline, fire-escape strands, lunch-volume dos, ELO afros in slow-motion argument. Product off-screen. Not the Ultra Screech ad. Imagine audio prompt is stems the same length as each clip, not the full 2:47.",
    visualArc: "Kenji tag on stage → Lillith verse → fire-escape strand → pre-chorus lift → chorus hair-skyline → Rubella under the fringe / lunch dos → laundry look-through → Kenji solo hair-blocks → bridge on stage → stacked chorus intercut → Kenji tag again.",
    tags: ["glam-metal", "catalog", "lillith", "rubella", "kenji", "glamora", "hair-city"],
    segments: [
      {
        id: "big-city-a-kenji-tag",
        label: "A — Kenji tag, stage",
        start: "0:00",
        end: "0:08",
        durationSec: 8,
        onScreen: "Kenji tag, stage",
        lyrics: "",
        musicCue: "",
      ...
      },
      {
        ...
        label: "B — Lillith verse 1, stage",
        start: "0:08",
        end: "0:23",
        durationSec: 15,
        onScreen: "Lillith verse 1, stage",
        lyrics: "",
        musicCue: "",
      ...
      },
      {
        ...
        label: "C — Fire-escape strand",
        start: "0:15",
        end: "0:23",
        durationSec: 8,
        onScreen: "Fire-escape strand",
        lyrics: "",
        musicCue: "",
      ...
      },
      {
        ...
        label: "D — Pre-chorus lift, stage",
        start: "0:23",
        end: "0:31",
        durationSec: 8,
        onScreen: "Pre-chorus lift, stage",
        lyrics: "",
        musicCue: "",
      ...
      },
      {
        ...
        label: "E — Hair skyline chorus lock",
        start: "0:31",
        end: "0:46",
        durationSec: 15,
        onScreen: "Hair skyline chorus lock",
        lyrics: "",
        musicCue: "",
      ...
      },
      {
        ...
        label: "F — Rubella verse 2, stage",
        start: "0:46",
        end: "1:01",
        durationSec: 15,
        onScreen: "Rubella verse 2, stage",
        lyrics: "",
        musicCue: "",
      ...
      },
      {
        ...
        label: "G — Fringe / lunch / laundry",
        start: "0:54",
        end: "1:16",
        durationSec: 22,
        onScreen: "Fringe / lunch / laundry",
        lyrics: "",
        musicCue: "",
      ...
      },
      {
        ...
        label: "H — Solo: headstock → hair-blocks",
        start: "1:16",
        end: "1:31",
        durationSec: 15,
        onScreen: "Solo: headstock → hair-blocks",
        lyrics: "",
        musicCue: "",
      ...
      },
      {
        ...
        label: "I — Bridge on stage",
        start: "1:31",
        end: "1:46",
        durationSec: 15,
        onScreen: "Bridge on stage",
        lyrics: "",
        musicCue: "",
      ...
      },
      {
        ...
        label: "J — Final chorus intercut + K2",
        start: "1:46",
        end: "2:47",
        durationSec: 61,
        onScreen: "Final chorus intercut + K2",
        lyrics: "",
        musicCue: "",
        grokImaginePrompt: "",
        geminiOmniPrompt: "",
  ...
  },
  {
    ...
    title: "Chroma Bath",
    status: "ready-to-generate",
    runtime: "2:00 (8 segments)",
    episode: "Musical Cutaway / Visual Experiment",
    songId: "deep-space-drift",
    songTitle: "Deep Space Drift (instrumental bed)",
    summary: "Pure non-representational color. No object at all — no blob, no sphere, no horizon, no figure. Eight segments, each a different processing dialect applied to a swirling color field: ink bleed, video feedback, slit-scan, datamosh, refraction, print misregistration, granulation, bleach. There is no black in the piece; the darkest value is a glowing indigo.",
    visualArc: "Ink bleeding in water → feedback tunnel → slit-scan lanes → compression smear → refraction through turning glass → misregistered print → granular shatter and reassembly → everything bleaches to warm white.",
    tags: ["abstract", "psychedelic", "pure-visual", "color-field", "processing", "no-objects", "eyewash", "visual-experiment", "long-form-prompts"],
    segments: [
      {
        id: "chroma-bath-a-bleed",
        label: "A — Bleed",
        start: "0:00",
        end: "0:12",
        durationSec: 12,
        onScreen: "Cold water, macro. Magenta and acid-lime ink walk into each other by capillary action, hold a vibrating seam, and refuse to make brown.",
        lyrics: "",
        musicCue: "Deep Space Drift fades up from silence; volume-pedal swell, no attack, long reverb tail. No percussion. No foley.",
      ...
      },
      {
        ...
        durationSec: 16,
        onScreen: "The field re-enters itself. A recursive tunnel of cyan and sodium orange, each generation smaller, hotter, and rotated a few degrees, receding forever without arriving.",
        lyrics: "",
        musicCue: "Deep Space Drift continues; octave-shifted delay cascade under the swell, tails stacking the way the image stacks.",
      ...
      },
      {
        ...
        durationSec: 16,
        onScreen: "Time smeared across the horizontal. Violet and gold drawn into parallel lanes, a single instant stretched the full width of the frame, the swirl sheared into a comb.",
        lyrics: "",
        musicCue: "Deep Space Drift; a long luminous glissando runs the length of the segment, matching the horizontal smear.",
      ...
      },
      {
        ...
        durationSec: 16,
        onScreen: "The picture is gone but the motion survives. Teal and hot coral macroblocks carry old color into new shapes, smearing where the frame should have refreshed.",
        lyrics: "",
        musicCue: "Deep Space Drift first swell; granular synthesis dissolving each sustained steel note into drifting particles under the smear.",
      ...
      },
      {
        ...
        durationSec: 16,
        onScreen: "The field seen through moving glass. Emerald and rose split at every boundary into their components, and the glass keeps turning.",
        lyrics: "",
        musicCue: "Deep Space Drift; delicate flageolet harmonics ringing over the pad as the dispersion opens.",
      ...
      },
      {
        ...
        label: "F — Misregistration",
        start: "1:16",
        end: "1:30",
        durationSec: 14,
        onScreen: "Ultramarine, sulphur, and a slipped magenta plate. Print gone wrong — moiré, dot crawl, and a white gap where the colors should have met.",
        lyrics: "",
        musicCue: "Deep Space Drift; the pad thins to a single sustained tone, harmony migrating a semitone under the slip.",
      ...
      },
      {
        ...
        durationSec: 16,
        onScreen: "The field shatters into countable grains. Oxblood and mint drift as a cloud, then reassemble into a swirl that is almost, but not quite, the one they left.",
        lyrics: "",
        musicCue: "Deep Space Drift tail begins; granular mist of the steel note, reforming imperfectly — the picture and the bed do the same thing here on purpose.",
      ...
      },
      {
        ...
        durationSec: 14,
        onScreen: "Every hue the piece has spent arrives at once and cancels into a single warm white. One last swirl turns inside the white and goes still. The indigo is the last thing to leave.",
        lyrics: "",
        musicCue: "Deep Space Drift reverb tail only, no new notes. Lets the room run out. Optional Continuity Voice after full white — see notes.",
  ...
  },
  {
    ...
    songTitle: "Twilight Time (kick grid)",
    summary: "Pure non-representational color at warehouse tempo. No object — no blob, no sphere, no horizon, no figure. Eight six-second dialects: strobe invert, whip smear, phosphor stack, smash zoom, channel chase, hard cuts, vortex spin-up, white hit. The slow sibling is Chroma Bath. This one hits.",
    visualArc: "Kick-locked invert → smear streaks → afterimage pile → smash zoom tunnel → RGB plates at three speeds → six hard hue swaps → vortex past readable → one white punch and wreckage.",
    tags: ["abstract", "psychedelic", "pure-visual", "color-field", "fast-motion", "fast-chroma", "strobe", "beat-sync", "no-objects", "eyewash", "visual-experiment", "long-form-prompts"],
    segments: [
      {
        id: "color-whip-a-strobe",
        label: "A — Strobe",
        start: "0:00",
        end: "0:06",
        durationSec: 6,
        onScreen: "Full-frame magenta and acid-lime invert on every kick. Fifteen punches. One-frame black between. Nothing else moves.",
        lyrics: "[Instrumental — no vocal]",
        musicCue: "Twilight Time, 150 BPM. Color inverts on the kick. No swell, no fade.",
      ...
      },
      {
        ...
        durationSec: 6,
        onScreen: "One violent horizontal whip. Cyan and sodium orange become a comb of streaks. The whip does not stop; it is the shot.",
        lyrics: "[Instrumental — no vocal]",
        musicCue: "Twilight Time. Smear length locked to the kick; streaks refresh every 0.4s.",
      ...
      },
      {
        ...
        durationSec: 6,
        onScreen: "Violet and gold. Each kick stamps a ghost of the last frame. Ghosts pile until the field is a stack of delayed color.",
        lyrics: "[Instrumental — no vocal]",
        musicCue: "Twilight Time. Each kick adds a ghost; ghosts never fully die in six seconds.",
      ...
      },
      {
        ...
        durationSec: 6,
        onScreen: "Teal and hot coral rush at camera. Smash-zoom through a color tunnel that never arrives.",
        lyrics: "[Instrumental — no vocal]",
        musicCue: "Twilight Time build. Each kick is a smash; fifteen smashes, no settle.",
      ...
      },
      {
        ...
        durationSec: 6,
        onScreen: "Red, phosphor green, and cobalt plates of the same field running at three speeds. The picture never registers.",
        lyrics: "[Instrumental — no vocal]",
        musicCue: "Twilight Time. Red on the kick, green a sixteenth late, cobalt a sixteenth early.",
      ...
      },
      {
        ...
        durationSec: 6,
        onScreen: "Six full-frame hue swaps. Ultramarine. Sulphur. Ultramarine. Sulphur. No dissolve. The cut is the motion.",
        lyrics: "[Instrumental — no vocal]",
        musicCue: "Twilight Time. A cut every 2.5 kicks so six swaps land in six seconds, off the snare.",
      ...
      },
      {
        ...
        durationSec: 6,
        onScreen: "Oxblood and mint spiral. Rotation accelerates past readable. The center is off-center and empty of objects.",
        lyrics: "[Instrumental — no vocal]",
        musicCue: "Twilight Time drop. Spin doubles every four kicks. Last kicks are unreadable.",
      ...
      },
      {
        ...
        durationSec: 6,
        onScreen: "Every spent hue arrives at once, punches to overexposed white on one kick, and the wreckage of color hangs in the afterimage.",
        lyrics: "[Instrumental — no vocal]",
        musicCue: "Twilight Time. One kick is the white punch (about 0:44). Wreckage chatters on the remaining kicks. Hard out at 0:48, no tail.",
  ...
  },
  {
    id: "rubella-stand-up",
    kind: "gag",
    title: "Rubella Stand-Up",
    status: "ready-to-generate",
    runtime: "60–75s + three 6–8s tags",
    episode: "Short packet farm / spoken cutaway",
    songId: "rubella-stand-up",
    songTitle: "Rubella Stand-Up (Voice Bed)",
    summary: "Item Seven: Resident Comments. The podium is a laundry-room intercom. Madelyn put her on the list. Folding chairs creak; they do not clap. Spoken Voice bed, not a musical.",
    visualArc: "Podium lock → detergent relic → heckle wide (she does not turn) → land with duplicate forms.",
    tags: ["gag", "spoken", "laundry", "hoa", "rubella", "lillith", "farm-22", "voice-bed"],
    segments: [
      {
        id: "rubella-stand-a-podium-lock",
        label: "A — Podium Lock",
        start: "0:00",
        end: "0:20",
        durationSec: 20,
        onScreen: "Rubella behind the honey-oak table, unused brass mic, half-empty mug, fluorescent hallway bleed, empty first row, resignation face.",
        lyrics: "Good evening. I'm Rubella. Item Seven. Resident comments. I didn't put my name on the list. The list put my name on me. This is the laundry intercom. If your dryer starts, that's not applause. I filed a ticket. The ticket hummed back. I used to do quality assurance. The company erased Human Resources. And the backups. My pension went with final_final_2. I moved here for cheap rent. I found a building that negotiates.",
        musicCue: "Dry raspy Voice bed, slight hallway slap, fluorescent tick. No music. Mug set down like evidence.",
      ...
      },
      {
        ...
        label: "B — Detergent Relic",
        start: "0:20",
        end: "0:38",
        durationSec: 18,
        onScreen: "Mid-set, unlabeled bottle in the off-hand like a sacred object, lace, chairs in soft focus.",
        lyrics: "The elevator just tried to negotiate. I told it I already pay rent. That's a counteroffer with a ding. I don't need a hero. I need the detergent that still works. I keep a bottle. Contraband. It still finishes a cycle.",
        musicCue: "Voice bed continues. One chair creak on \"ding,\" peggy-babcock-second sibling. No chirp flock.",
      ...
      },
      {
        ...
        durationSec: 20,
        onScreen: "Two identical forms in her hand. Mug empty. Mic still unused in spirit. Chairs have crept one inch back.",
        lyrics: "If the floor is on fire again, I'm charging it for emotional damages. I already have the form. They duplicated it. Nobody filed anything. That's my time. The chairs can creak. I'm waiting for a dryer that does not summon anything.",
        musicCue: "Chair creak in unison on the land. Fluorescent tick. End. No sitcom whoops.",
      ...
      },
      {
        ...
        label: "E — Tag Elevator",
        start: "1:12",
        end: "1:19",
        durationSec: 7,
        onScreen: "Same podium lock. Interrupt sibling. Echo plus chair creak.",
        lyrics: "The elevator just tried to negotiate. I told it I already pay rent. That's a counteroffer with a ding.",
        musicCue: "Same mic. Hallway slap. Chair creak on ding. 7s. Cut-down, not a second packet.",
      ...
      },
      {
        ...
        label: "F — Tag Detergent",
        start: "1:19",
        end: "1:25",
        durationSec: 6,
        onScreen: "Bottle in the off-hand for one beat. Interrupt sibling.",
        lyrics: "I don't need a hero. I need the detergent that still works. Contraband. It still finishes a cycle.",
        musicCue: "Same mic. 6s. No brand sting. No Ultra Screech.",
      ...
      },
      {
        ...
        label: "G — Tag Emotional Damages",
        start: "1:25",
        end: "1:33",
        durationSec: 8,
        onScreen: "Form duplicates in her hand. Interrupt sibling.",
        lyrics: "If the floor is on fire again, I'm charging it for emotional damages. I already have the form. They duplicated it. Nobody filed anything.",
        musicCue: "Same mic. 8s. Fluorescent tick on the out.",
  ...
  },
  {
    ...
    songId: "well-fall",
    songTitle: "Well Fall",
    summary: "POV down a real well, instrumental heavy metal, no vocal. Lip is locked. Click a sight into open slots B–G, or an ending into H — previews fill [SIGHT] in the prompts.",
